...
//                        q2 = ParseQuery.getQuery("UnivDetail");
//                        q2.whereEqualTo("univName",univnameSelected);
//                        q2.getFirstInBackground(new GetCallback() {
//                            @Override
...
//                                String abc= ud.getObjectID();
                              ...
                              /*  ParseQuery<ParseObject> query = ParseQuery.getQuery("UnivDetail");
                                query.whereEqualTo("univName", univname);
                                query.getFirstInBackground(new GetCallback<ParseObject>() {
                                    @Override
                                    public void done(ParseObject parseObject, ParseException e) {
                                        userInfo.put("prevUnivName", );
                                     /*   ParseQuery<ParseObject> query2 = ParseQuery.getQuery("UserInfo");
                                        query2.whereEqualTo("userId", currUser);
                                        query2.getFirstInBackground(new GetCallback<ParseObject>() {
                                            @Override
                                            public void done(ParseObject parseObject, ParseException e) {
                                                parseObject.put("prevUnivName", objId);
                                            }
                                        }); */
